function [ sigma_v, PorePressure, sigma_t ] = sigma_v_calc_CPT_GUI( Soil_Elev2, Soil_Type, GWT1, Ground_Elev1, Gamma1)
        ...
        if Soil_Elev(i,j)~=0
            ...
            if (strcmp(Soil_Type{i,j},'GW')|| strcmp(Soil_Type{i,j},'GP'))
                if j == 1
                    ...
                    sigma_t(i,j) = Gamma(i,j)*(Soil_Elev(i,j-1)-Soil_Elev(i,j))+sigma_t(i,j-1);
                end
